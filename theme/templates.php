        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Volunteer Portal<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <address>
          <strong>Volunteer Portal</strong><br>
          <br>
           </address>
          <p>
            <i class="icon-phone"></i> (123) 456-789 <br>
            <i class="icon-envelope-alt"></i> vp@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
